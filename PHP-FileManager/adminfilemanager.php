<?
//a:9:{s:4:"lang";s:2:"en";s:9:"auth_pass";s:32:"d41d8cd98f00b204e9800998ecf8427e";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:0:"";s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:1227471355;s:7:"version";s:5:"0.9.3";}
...
global $isAwarded, $awardDir,$curDir, $companyDir, $workDir, $webAdmin, $libWorkDir, $teamWorkDir;
global $teamManager,$teamName,$directoryHome, $section, $dir_atual, $teamDir;
if ( $webAdmin == "no" && $teamManger == "no")
...
if (!isset($dir_atual)){
    ...
    if ( $webAdmin == "no" && $section == "config" && ( ( strpos($dir_atual, $libWorkDir) > 0 || strpos($dir_atual,$teamWorkDir) > 0 ) && strpos($dir_atual,$teamName) < 1 ) ) {
            $dir_atual .= $teamName;
        }
}
...
function dir_list_form() {
    ...
    global $curDir, $companyDir, $workDir, $webAdmin, $teamManager, $libDir, $libWorkDir, $awardDir, $teamName;
    ...
    if ( $dirExists == true ) {
            ...
            $out .= "
                <tr><td bgcolor=\"#".$fm_color['Bg']."\" colspan=20><nobr>&nbsp;&nbsp;<font size='3' bold>".strtoupper($teamName)." Team</font></nobr></td></tr>";
            $out .= "
            ...
            $out .= "<input type=button onclick=\"test_prompt(1)\" value=\"".et('CreateDir')."\">
            ...
            if($entry_count){
                    ...
                    $out .= "
                        <tr><td bgcolor=\"#".$fm_color['Bg']."\" colspan=20><nobr>$uplink <a href=\"".$path_info["basename"]."?frame=3&dir_atual=$dir_atual\">Refresh</a>&nbsp;&nbsp;".$wrkDir."</nobr></td></tr>
                        <tr>
                        <td bgcolor=\"#".$fm_color['Bg']."\" colspan=20><nobr>
                                    ...
                                    if ( $displayDir == true ) {
                                            ...
                                            $dir_out .= "
                                                ...
                                                if ( is_writable($dir_atual.$file) ) $dir_out .= "
                                                        <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"JavaScript:if(confirm('".et('ConfRem')." \\'".$file."\\' ?')) document.location.href='".$path_info["basename"]."?frame=3&action=8&cmd_arg=".$file."&dir_atual=$dir_atual'\">".et('Rem')."</a>
                                                        <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"JavaScript:rename('$file')\">".et('Ren')."</a>";
                                            $dir_out .= "
                                                <td bgcolor=\"#".$fm_color['Bg']."\" align=center>";
                                        }
                                    $dir_out .= "
                                    ...
                                    if ( $displayDir == true ) {
                                            ...
                                            $file_out .= "
                                                ...
                                                if ( is_writable($dir_atual.$file) ) { $file_out .= "
                                                        <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"javascript:if(confirm('".strtoupper(et('Rem'))." \\'".$file."\\' ?')) document.location.href='".$path_info["basename"]."?frame=3&action=8&cmd_arg=".$file."&dir_atual=$dir_atual'\">".et('Rem')."</a>
                                                        <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"javascript:rename('$file')\">".et('Ren')."</a>";
                                                } else {
                                                    $file_out .= "
                                                        <td bgcolor=\"#".$fm_color['Bg']."\" align=center>
                                                ...
                                                if ( is_readable($dir_atual.$file) && (strpos(".wav#.mp3#.mid#.avi#.mov#.mpeg#.mpg#.rm#.iso#.bin#.img#.dll#.psd#.fla#.swf#.class#.ppt#.jpg#.gif#.png#.wmf#.eps#.bmp#.msi#.exe#.com#.rar#.tar#.zip#.bz2#.tbz2#.bz#.tbz#.bzip#.gzip#.gz#.tgz#", $dir_entry["ext"]."#" ) === false)) { $file_out .= "
                                                        <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"javascript:edit_file('$file')\">".et('Edit')."</a>";
                                                } else {
                                                        if ( is_readable($dir_atual.$file) && strlen($dir_entry["ext"]) && (strpos(".rar#.tar#.zip#.bz2#.tbz2#.bz#.tbz#.bzip#.gzip#.gz#.tgz#", $dir_entry["ext"]."#" ) !== false)) { $file_out .= "
                                                                <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"javascript:decompress('$file')\">".et('Decompress')."</a>";
                                                        } else {
                                                                if( $is_reachable && is_readable($dir_atual.$file) && (strpos(".sys#.bat#.ini#.conf#.swf#.php#.php3#.asp#.html#.htm#.jpg#.gif#.png#.bmp#", $dir_entry["ext"]."#" ) !== false)) { $file_out .= "
                                                                        <td bgcolor=\"#".$fm_color['File']."\" align=center><a href=\"javascript:view('$file');\">".et('View')."</a>";
                                                                }
                                                        }
                                                }
                                            $file_out .= "</tr>";
                    ...
                    $out .= $dir_out;
                        ...
                        //                      <td bgcolor=\"#".$fm_color['Bg']."\"><a href=\"".$path_info["basename"]."?frame=3&or_by=$or7&dir_atual=$dir_atual\">".et('Type')."</a>";
                        //                $out .= "
                        //                      <td bgcolor=\"#".$fm_color['Bg']."\" colspan=20>";
                        //
                        //            }
                    $out .= $file_out;
                    $out .= "
