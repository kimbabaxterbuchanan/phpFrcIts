<?php
//a:9:{s:4:"lang";s:2:"en";s:9:"auth_pass";s:32:"d41d8cd98f00b204e9800998ecf8427e";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:0:"";s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:1227807782;s:7:"version";s:5:"0.9.3";}
require_once dirname(__FILE__) .'/../PHP-GlobalIncludes/auth.php';
require_once dirname(__FILE__) .'/../PHP-Actions/proposalFormAction.php';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        ?>
        <form id="proposalForm" name="proposalForm" method="post" action="proposalForm.php">
                        ...
                        <tr>
                            <td>
                                <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
                                    <?php if ( $teamManager == "yes" && $formAction != "delete" && $formAction != "view" ) { ?>
                                            ...
                                            <tr>
                                                <th>Performance Period</th>
                                                    ...
                                                    <tr>
                                                    <?php
                                                            $img = "<a href=\"javascript:popCal('received_dt','proposalForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                        ?>
                                        <th>Received Date</th>
                                    ...
                                    <tr>
                                    <?php
                                            $img = "<a href=\"javascript:popCal('questionDue_dt','proposalForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                        ?>
                                    ...
                                    <tr>
                                    <?php
                                            $img = "<a href=\"javascript:popCal('draftDue_dt','proposalForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                        ?>
                                    ...
                                    <tr>
                                    <?php
                                            $img = "<a href=\"javascript:popCal('finalDue_dt','proposalForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                        ?>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <iframe bgcolor="#000000" class="style1" width="99%" height="600" src="../PHP-FileManager/filemanager.php?section=proposal" name="frame3" border="0" marginwidth="0" marginheight="0">
                                                </td>
                                            </tr>
                                        </table>
                                        <?php } ?>
