...
require_once dirname(__FILE__) .'/../PHP-Actions/toAwardsListFormAction.php';
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="toAwardsListForm" name="toAwardsListForm" method="post" action="toAwardsListForm.php">
            ...
            <h1>List To Awards</h1>
            <table>
            <?php if ( $section == "config" ) { ?>
                <tr>
                    <td>
                        <a href="toAwardsForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=">Create New ToAwards</a>
                    </td>
                </tr>
            <?php } ?>
                <tr>
                    <td>
                        <table width="500" border="1" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                <?php if ( $section != "config" ) { ?>
                                         <a href="toAwardsForm.php?id=<?=$res['id']?>&docNumber=<?=$res['docNumber']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=view"><?=$res['docNumber']?></a>
                                <?php } else { ?>
                                         <?=$res['docNumber']?>
                                <?php } ?>
                                </td>
                                ...
                                <td align="center">
                                    <table>
                                        <tr>
                                            <td align="center">
                                                <a href="toAwardsForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=edit">Edit</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                                    <a href="toAwardsForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=delete">Delete</a>
                                </td>
                                <?php } ?>
                            </tr>
                            <?php
