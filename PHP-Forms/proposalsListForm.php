...
require_once dirname(__FILE__) .'/../PHP-Actions/proposalsListFormAction.php';
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="proposalsListForm" name="proposalsListForm" method="post" action="proposalsListForm.php">
            ...
            <h1>List Proposals</h1>
            <table>
            <?php if ( $section == "config" ) { ?>
                <tr>
                    <td>
                        <a href="proposalForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=">Create New Proposal</a>
                    </td>
                </tr>
                <?php } ?>
                <tr>
                    <td>
                        <table width="500" border="1" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                                <td>
                                <?php if ( $section != "config" ) { ?>
                                         <a href="proposalForm.php?id=<?=$res['id']?>&docNumber=<?=$res['docNumber']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=view"><?=$res['docNumber']?></a>
                                <?php } else { ?>
                                         <?=$res['docNumber']?>
                                <?php } ?>
                                </td>
                                ...
                                <td align="center">
                                    <table>
                                        <tr>
                                            <td align="center">
                                                <a href="proposalForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=edit">Edit</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td>
                                    <a href="proposalForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=delete">Delete</a>
                                </td>
                                <?php } ?>
                            </tr>
                            <?php
