...
require_once dirname(__FILE__) .'/../PHP-Actions/toRFQsFormAction.php';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
      <h1>To RFQ Form</h1>
        ...
        ?>
        <form id="toRFQsForm" name="toRFQsForm" method="post" action="toRFQsForm.php">
                ...
                <tr>
                    <td>
                        <table width="300" border="0" align="center" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                                <?php
                                    $img = "<a href=\"javascript:popCal('received_dt','toRFQsForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                ?>
                                <th>Received Date</th>
                            ...
                            <tr>
                                <?php
                                    $img = "<a href=\"javascript:popCal('questionDue_dt','toRFQsForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                ?>
                            ...
                            <tr>
                                <?php
                                    $img = "<a href=\"javascript:popCal('draftDue_dt','toRFQsForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                ?>
                            ...
                            <tr>
                                <?php
                                    $img = "<a href=\"javascript:popCal('finalDue_dt','toRFQsForm')\"><img style=\"position:relative; top:3px;\" width=15px height=15px; src=\"../PHP-images/calendar.gif\" border=\"0\"></a>";
                                ?>
                                          ...
                                          <tr>
                                              <td>
                                                  <table width="100%">
                                                      <tr>
                                                          <td>
                                                            <iframe bgcolor="#000000" class="style1" width="99%" height="600" src="../PHP-FileManager/filemanager.php?section=toRFQs" name="frame3" border="0" marginwidth="0" marginheight="0">
                                                          </td>
                                                      </tr>
                                                  </table>
                                <?php } ?>
