...
require_once dirname(__FILE__) .'/../PHP-Actions/emailListFormAction.php';
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
         <form id="emailListForm" name="emailListForm" method="post" action="emailListForm.php">
            ...
            <h1>List Saved Email Templates</h1>
            <table>
                <tr>
                    <td>
                        <a href="emailForm.php?section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=">Create New Email</a>
                        &nbsp;&nbsp;&nbsp;
                        <a href="sendMailForm.php?section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=">Send New Email</a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="500" border="1" align="center" cellpadding="2" cellspacing="0">
                            ...
                            <tr>
                               <td nowrap>
                                ...
                                <?php } ?>
                                <td>
                                    <a href="sendMailForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=mail">Mail</a>
                                </td>
                                <td>
                                    <a href="emailForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=edit">Edit</a>
                                </td>
                                <?php if ( $res['login'] != "admin" ) {  ?>
                                    <td>
                                        <a href="emailForm.php?id=<?=$res['id']?>&section=<?=$section?>&sub_section=<?=$sub_section?>&formAction=delete">Delete</a>
                                    </td>
                                <?php } else {  ?>
                                    <td>&nbsp;</td>
                                <?php } ?>
